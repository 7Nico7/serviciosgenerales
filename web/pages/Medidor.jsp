...
<html>
    ...
    <body>
            ...
            <div class="col-md-16">
                <div class="card">
                    <div class="card-header text-white">
                        <div class="titulo">
                            <h5>Lista de Medidores</h5>
                            <a href='ControllerCFE?pagina=nuevoMedidor' class="btn btn-sm btn-primary text-right">Nuevo</a>
                        </div>
                    </div>   
                </div>
                <div align="center">
                    <table id="Medidor" class="table table-bordered display nowrap" width="100%">
                        <thead>
                            <tr>                 
                                <th>No.</th>
                                <th>Partida</th>
        ...
        <script src="pages/js.main/Medidor.js" type="text/javascript"></script>
    </body>
</html>
<%
}else{
