...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-17">
                <div class="card">
                    ...
                    ${mensaje}
                    <div class="card-body">
                        <form action="ControllerEditar?Editar=Bien&cve_bienes=${bien.cve_bienes}" method="POST">
                            <div class="form-row" >
        ...
        <script>
            ...
            var estado = '${bien.status}';
            var id = "${bien.cve_bienes}";

            var objetoDescripcion = "${bien.unidad}";
            var marca = "${bien.marca}";
            var modelo = "${bien.modelo}";
            var serie = "${bien.serie}";
            var inventario = "${bien.num_inventario}";
            var fechaFactura = "${bien.fecha_factura}";
            var fechaAltaSistema = "${bien.fecha_instalacion}";
            var ubicacionTxt = "${bien.ubic_departamento}";
            var responsable = "${bien.responsable}";
            var tonner = "${bien.tonner}";
            var dependencia = "${bien.dependencia}";
            var departamento = "${bien.departamento}";
            var area = "${bien.area}";
            var ubicacionObservacion = "${bien.ubicaObservaciones}";

        </script>
        <script src="pages/js.main/editarBien.js" type="text/javascript"></script>
    </body>
</html>
<%
}else{
