            ...
            <div class="col-md-16">
                <div class="card">
                    <div class="card-header text-white">
                        <div class="titulo">
                            <h5>Lista De Salidas Sin Concretar</h5>
                            <div>
                                <a href='ControllerVehiculos?pagina=nuevaSalida' class="btn btn-sm btn-primary text-right">Nueva Salida</a>
                                <a href='ControllerVehiculos?pagina=concretarSalida' class="btn btn-sm btn-primary text-right">Concretar Salida</a>
                                <a href='ControllerVehiculos?pagina=salidasSinConcretar' class="btn btn-sm btn-primary text-right">Salidas sin Concretar</a>
                                <a href='ControllerVehiculos?pagina=salidasConcretadas' class="btn btn-sm btn-primary text-right">Salidas Concretadas</a>
                            </div>
                        </div>
                    </div>   
                </div>
                <div align="center">
                    <table id="salidas" class="table table-bordered display nowrap" width="100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Vehiculo</th>
