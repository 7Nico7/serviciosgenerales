            ...
            <div class="col-md-17">
                <div class="card">
                    <div class="card-header ">
                        <h5 class="text-white">Carga de Combustible</h5>
                    </div>   
                    ${mensaje}
                    <div class="card-body">
                        <form action="ControllerVehiculos?guardar=gasolina" method="post" onsubmit="guardar.disabled = true; return true;">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label>Cantida en Litros</label>
                                    <input class="form-control" type="number" step="0.01" min=".01" placeholder="00.00L"  name='litros' id="litros" required="required"/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Precio</label>
                                    <input class="form-control" type="number" step="0.01" min=".01" placeholder="00.00$" name="precio" id="precio" required="required"> 
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Importe</label>
                                    <input class="form-control" type="number" step="0.01" min=".01" name='importe' id="importe" placeholder="00.00$"  required="required"/>
                                </div>
                            </div>

                            <div class="form-group" align="center">
                                <input type="button" name="Regresar" value="Regresar"  class="btn btn-dark" onClick="location.href = 'ControllerVehiculos?pagina=gasolina'">
