                ...
                <div class="card">
                    <div class="card-header text-white">
                        <div class="titulo">
                            <h5>${data[0]}</h5>
                            <div>
                                <a href="ControllerBienes?selecciono=Bienes&Tipo=extintores" class="btn btn-sm btn-primary text-right">Extintores</a>
                                <a href='ControllerBienes?selecciono=Bienes&Tipo=climas' class="btn btn-sm btn-primary text-right">Climas</a>
                                <a href='ControllerBienes?selecciono=Bienes&Tipo=impresoras' class="btn btn-sm btn-primary text-right">Impresoras</a> 
                                <a href='ControllerBienes?selecciono=Bienes&Tipo=todos' class="btn btn-sm btn-primary text-right">Todos</a>
                                <a href='ControllerBienes?selecciono=nuevoBien' class="btn btn-sm btn-primary text-right">Nuevo</a>
                            </div>
                        </div>
                    </div>   
                </div>
