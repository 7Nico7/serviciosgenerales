...
<html>
    ...
    <body>
            ...
            <div class="col-md-17">
                <div class="card">
                    <div class="card-header ">
                        <h5 class="text-white">Editar Recibo</h5>
                    </div>   
                    ${mensaje}
                    <div class="card-body">
                        <form id="nuevoBien" action="ControllerEditar?Editar=Recibo" method="post" enctype="multipart/form-data" onsubmit="guardar.disabled = true; return true;">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label>No.Recibo</label>
                                    <input class="form-control" type="text" readonly name='cve_recibo' id="cve_recibo" required="required"/>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    <label>Consumo</label>
                                    <input class="form-control" type="text" name='consumo' id="consumo" required="required"/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>saldo</label>
                                    <input class="form-control" type="text" name='saldo' id="saldo" required="required"/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Cambiar el Recibo</label>
                                    <div class="custom-file">
                                        ...
                                        <input  class="form-control" type="text" name="eliminarArchivoCFE" id="eliminarArchivoCFE" oncopy="return false;" readonly style="display: none">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Cambiar Reporte</label>
                                    <div class="custom-file">
                                        ...
                                        <input  class="form-control" type="text" name="eliminarArchivoReporte" id="eliminarArchivoReporte" oncopy="return false;" readonly style="display: none">
                                    </div>
                                </div>
                            </div>
        ...
        <script src="pages/js.main/editarRecibo.js" type="text/javascript"></script>
    </body>
</html>
<%
}else{
