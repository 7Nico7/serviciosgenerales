...
function NumeroIventarios(tipo) {
    ...
    $.each(data, function (i, val) {
        ...
        if (val.tipo_bien === tipo) {
            console.log("entro : " + val.tipo_bien + " tipo : " + tipo);
            console.log("entro : " + val.num_inventario + " ID : " + val.cve_bienes);
...
function  clicInventario(tipo) {
    ...
    if (numInventario !== "Seleccionar..." || numInventario !== null) {
        for (var i = 0; i < inventario.length; i++) {
            if (inventario[i] === numInventario && tipo_bien[i] === tipo) {
//$("#cve_bienes").attr("readonly", true);
